...
public class MedievalGame {
	...
	private Player start(Scanner console) {
		...
		while (true) {
			...
			if (answer.equals("y")) {
				...
				while (true) {
					System.out.println("Welcome " + possibleName
							+ ", am I pronouncing that correctly? (Enter 'y' to confirm, 'n' to enter a new name");
				...
				System.out.print(
						"Sorry adventurer, I only speak the common tongue, please enter 'y' to load a game or 'n' to start a new game: ");
	...
	private Player load(String playerName, Scanner console) {
		...
		try {
			...
			System.out.println(
					"If you're sure the spelling is correct, your character file may no longer exist, please reload the game if you'd like to try again.");
